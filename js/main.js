...
(function($) {
    ...
    $window.on('scroll', function() {
        ...
        if(scroll<=50) {
            ...
            logodefault.attr('src', 'https://campusvirtual.up.edu.pe/img/logo-up.png');
            ...
            logoinner.attr('src', 'https://campusvirtual.up.edu.pe/img/logo-up.png');
            logodefault.attr('src', 'https://campusvirtual.up.edu.pe/img/logo-up.png');
            logowhite.attr('src', 'img/logos/logo-white.png');
            ...
            tpj(document).ready(function() {
                if(tpj("#rev_slider_2").revolution==undefined) {
                    ...
                    revapi2=tpj("#rev_slider_2").show().revolution( {
                        sliderType:"standard", sliderLayout:"auto", dottedOverlay:"none", delay:9000, spinner:"spinner4", navigation: {
                            keyboardNavigation:"off", keyboard_direction:"horizontal", mouseScrollNavigation:"off", onHoverStop:"off", touch: {
                                touchenabled: "on", swipe_threshold: 75, swipe_min_touches: 1, swipe_direction: "horizontal", drag_block_vertical: false
                            }
                            , arrows: {
                                enable:false, style:'metis', tmp:'', rtl:false, hide_onleave:true, hide_onmobile:true, hide_under:0, hide_over:9999, hide_delay:200, hide_delay_mobile:1200, left: {
                                    container: 'slider', h_align: 'left', v_align: 'center', h_offset: 20, v_offset: 0
                                }
                                , right: {
                                    container: 'slider', h_align: 'right', v_align: 'center', h_offset: 20, v_offset: 0
                        ...
                        , responsiveLevels:[1240, 1024, 767, 480], gridwidth:[1170, 1170, 767, 480], gridheight:[350, 350, 300, 300], lazyType:"none", shadow:0, shuffle:"off", autoHeight:"off",
                    }
                    );
                }
            }
