...
<head>
    ...
    <!--meta charset="utf-8"-->
    <meta name="author" content="Emprende Per�">
                                    ...
                                    <ul class="navbar-nav" id="nav" style="display: none;">
                                        <li><a href="#">Herramientas</a>
                                            <ul>
                                                ...
                                                <li><a target="_blank" href="http://mail.up.edu.pe">Correo Electr�nico</a></li>
                                                <li><a target="_blank" href="http://labvirtual.up.edu.pe/">Laboratorio virtual</a></li>
                                                <li><a target="_blank" href="http://srvnetappup.up.edu.pe/guiatelefonica/BuscarDirectorioTelf.aspx">Directorio telef�nico</a></li>
                                                ...
                                                Sistema de Informaci�n para la Gesti�n Universitaria (SIGU)</a></li>
                                                <li><a target="_blank" href="http://srvcom02.up.edu.pe:9080/siserpvi/">Paneles Virtuales</a></li>
                                                <li><a target="_blank" href="http://srvweb.up.edu.pe/si/index.jsp">Sistema de Informaci�n Institucional (SII)</a></li>
                                                ...
                                                <li><a target="_blank" href="http://vri.up.edu.pe/">Servicios para la investigaci�n</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="#">Informaci�n acad�mica</a>
                                            <ul>
                                                ...
                                                Asistencia</a></li>
                                                <li><a target="_blank" href="http://autoservicio1.up.edu.pe/ss/UP/EvaluacionDocente/Forms/UPEvaluacionDocenteResultadosHome.aspx">Resultados de evaluaci�n docente</a></li>
                                                <li><a target="_blank" href="http://autoservicio1.up.edu.pe/ss/Records/ClassSchedule.aspx">Horarios</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="#">Servicios</a>
                                            <ul>
                                                <li><a target="_blank" href="http://campusv.up.edu.pe/sisisemail/_data/2019/5692/Calendario_Academico_Regular_2019.pdf">Calendario acad�mico 2019</a></li>
                                                <li><a target="_blank" href="http://campusv.up.edu.pe/sisisemail/_data/2019/5635/Calendario Acad�mico Regular 2020.pdf">Calendario acad�mico 2020</a></li>
                                                <li><a target="_blank" href="https://campusvirtual.up.edu.pe/cafeteria/default.aspx">Cafeter�a</a></li>
                                                <li><a target="_blank" href="http://intranet.up.edu.pe:8080/site_cumpleanos/">Cumplea�os</a></li>
                                                ...
                                                <li><a target="_blank" href="http://campusvirtual.up.edu.pe/gestion_personas">Gesti�n de Personas</a></li>
                                                <li><a target="_blank" href="http://portalgiit.up.edu.pe">Gesti�n de la Informaci�n e Innovaci�n Tecnol�gica 
                                                (GIIT)</a></li>
                                        ...
                                        <li><a href="#">Contactos de servicios</a>
                                            <ul>
                                                ...
                                                <li><a target="_self" href="docentes/contacto-educacion-ejecutiva.html">Educaci�n Ejecutiva - CEE</a></li>
                                        ...
                                        <li><a href="#">La UP</a>
                                            <ul>
                                                ...
                                                <li><a target="_blank" href="http://www.up.edu.pe/aplicaciones/boletines/emprendeup/">Bolet�n Emprende UP</a></li>
                                                ...
                                                <li><a target="_blank" href="http://defensoriauniversitaria.up.edu.pe">Defensor�a Universitaria</a></li>
                                            </ul>
                                        </li>
                                        <li></li>
    ...
    <section style="padding-top: 0px;">
        <div class="container">
            <div class="text-center section-heading">
                ...
                <p class="width-85 sm-width-75 xs-width-95">El �rea de Marketing Institucional es responsable de la construcci�n, consolidaci�n y sostenimiento del posicionamiento de la Universidad del Pac�fico, buscando el cumplimiento de los objetivos de imagen y marca tanto de cada una de las Facultades y carreras, as� como tambi�n de las Unidades Institucionales, con una visi�n estrat�gica integrada.</p>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-6 sm-margin-30px-bottom">
                        <p class="margin-20px-top" style="color:#ffffff; font-size:18px; font-weight:bold;">Universidad del Pac�fico</p>
                        <p class="margin-15px-top" style="color:#ffffff;">Av. Salaverry 2020, Jes�s Mar�a, Lima, Per� // Tel. +51 1 2190100</p>
                    </div>

                    <div class="col-lg-3 col-md-6 sm-margin-30px-bottom"></div>

                    <div class="col-lg-4 col-md-6">
                        <p class="margin-20px-top" style="color:#ffffff; font-size:18px; font-weight:bold;">S�guenos</p>
